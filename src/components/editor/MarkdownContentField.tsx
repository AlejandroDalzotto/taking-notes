  ...
  return (
    <div className="relative flex-1 w-full h-full">
      <textarea
        ...
        spellCheck={false}
        className="absolute inset-0 z-10 p-4 text-3xl text-transparent bg-transparent outline-none resize-none caret-blue-50 placeholder:text-white/50 peer/input"
        placeholder="Write something here..."
        ref={textareaRef}
        onScroll={handleTextareaScroll}
      />
      <div
        className="absolute inset-0 p-4 overflow-y-auto text-3xl peer-hover/input:bg-white/[0.01] whitespace-pre-wrap transition-colors bg-transparent rounded"
